 ...
 * column. First proven on the Project model, now reused across every
 * dashboard-managed content type.
 */
trait HasLocalizedContent
{
    ...
    /**
     * Value of a bilingual JSON/array column ("highlights", "points", …) in the current locale.
     *
